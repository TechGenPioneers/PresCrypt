...
const AddHealthDataPage = ({ healthData, onSave }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Navigate to Patient Profile page after a short delay to show success message
      setTimeout(() => {
        router.push('/Patient/PatientProfile');
      }, 2000);
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="p-6">
            ...
            {/* Success Alert */}
            {success && (
              <div className="mb-6 bg-green-50 border border-green-200 p-4 rounded-xl flex items-center justify-between shadow-sm">
            ...
            {/* Error Alert */}
            {error && (
              <div className="mb-6 bg-red-50 border border-red-200 p-4 rounded-xl flex items-center justify-between shadow-sm">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
