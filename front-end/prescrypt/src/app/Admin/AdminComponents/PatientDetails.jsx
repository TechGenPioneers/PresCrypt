...
import { GetPatientById } from "../service/AdminPatientService";
...
const PatientDetails = ({ patientId }) => {
  ...
  const getPatientData = async () => {
    ...
    console.log("patient:", getPatient); // Not patientData here
  };
      ...
      <div>
        ...
        <div className="bg-[#E9FAF2] p-6 rounded-lg shadow-md sm:w-3/4 md:w-2/3 lg:w-1/2 xl:w-1/3 text-left">
          ...
          <div className="flex gap-1.5 m-1">
            ...
            <p className="text-gray-600">
              {patientData.patient.specialization}
            </p>
          </div>
          <div className="flex gap-1.5 m-1">
                    ...
                    <table className="w-full border-collapse">
                      ...
                      <tbody>
                        {patientData.appointments.map((appointments, index) => (
                          ...
                          >
                            <td className="p-3 text-[#094A4D]">{appointments.appointmentId}</td>
                            ...
                            <td className="p-3 text-[#094A4D]">{appointments.charge}</td>
                            ...
                            <td className="p-3 text-[#094A4D]">{appointments.specialNote}</td>
                            <td className="p-3 text-[#094A4D]">{appointments.typeOfAppointment}</td>
                            <td className="p-3 text-[#094A4D]">{appointments.createdAt}</td>
                            <td className="p-3 text-[#094A4D]">{appointments.updatedAt}</td>
