        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-[#033A3D] mb-3">
                Contact Information
              </h3>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-[#033A3D] font-medium">
              ...
              <div className="flex items-center space-x-3">
                ...
                <Link
                  href="mailto:prescrypt.health@gmail.com"
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Revolutionizing healthcare through secure digital prescription
                management. Our platform connects patients, doctors, with
                cutting-edge technology for better healthcare outcomes.
              </p>
            </div>
          </div>
