              ...
              {request.request.requestStatus === "Rejected" &&
                isWithin7Days(request.request.checkedAt) && (
                  <div className="flex flex-col items-start gap-1 lg:items-end">
                    ...
                    >
                      <button className="px-8 py-3 bg-[#A9C9CD] text-[#09424D] font-semibold rounded-xl hover:bg-[#91B4B8] transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
                        Manage Request
                      </button>
                    </Link>
                    <p className="text-sm mt-2 text-gray-600">
                      {getRemainingDays(request.request.checkedAt)} day(s)
                      remaining to manage this request.
                    </p>
                  </div>
                )}
            </div>
