  ...
  <div className="min-h-screen flex flex-col bg-gray-50">
    <div className="flex flex-grow">
     ...
     {/* Page content wrapper */}
        <div className="ml-8 group-hover:ml-[260px] w-full transition-all duration-300 pt-5 px-10 flex flex-col lg:flex-row justify-between gap-8 mt-5 mb-8">
     ...
     <div>
        ...
        <div className="w-[450px] bg-white shadow-xl p-8 rounded-xl border border-green-300">
          ...
          >
            {loading ? "Processing..." : `Contribute Rs ${price}`}
          </button>
        </div>
      </div>
    </div>
